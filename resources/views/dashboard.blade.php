...
@section('content')
{{-- Mulai isi dashboard dari <div class="row"> sampai selesai --}}
    {{-- <h1 class="fw-bold fs-3">Selamat datang, {{ auth()->user()->name }}</h1> --}}
    ...
    {{-- Copy konten dashboard dari index.html lo ke sini --}}
    @endsection