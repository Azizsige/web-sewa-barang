...
<body class="bg-gray-100 w-[460px] mx-auto relative">
                ...
                <div class="swiper-slide w-[200px]">
                    <a href="{{ route('produk') }}?category={{ $kategori->slug }}"
                        ...
                        <img src="{{ $kategori->image ?? 'https://flowbite.com/docs/images/logo.svg' }}" class="h-20"
                            alt="{{ $kategori->name }} Icon" loading="lazy" />
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Sembunyiin loading overlay pas DOM selesai load
            ...
            document.querySelectorAll('a[href^="/detail-produk"]').forEach(link => {
                link.addEventListener('click', function (e) {
                    ...
                    // Biar spinner keliatan sebelum navigasi
                    setTimeout(() => {
            ...
            dropdownItems.forEach(item => {
                item.addEventListener('click', function (e) {
                    ...
                    .then(products => {
                        ...
                        // Reattach event listener ke link baru
                        document.querySelectorAll('a[href^="/detail-produk"]').forEach(link => {
                            link.addEventListener('click', function (e) {
                                e.preventDefault();
                                loadingOverlay.classList.remove('hidden');
